...
import com.bydaffi.apartamentosapi.repositories.IClienteRepository;
import com.bydaffi.apartamentosapi.repositories.IPropiedadRepository;
import com.bydaffi.apartamentosapi.repositories.IReservaRepository;
...
import com.bydaffi.apartamentosapi.exceptions.ResourceNotFoundException;
import com.bydaffi.apartamentosapi.exceptions.ReferentialIntegrityException;
import com.bydaffi.apartamentosapi.exceptions.ResourceAlreadyExistsException;
...
public class ClienteService {
    ...
    public void deleteCliente(Long id) {
        ...
        // Verificar que no tiene propiedades
        ...
        // Verificar que no tiene reservas activas o futuras
    ...
    public Optional<ClienteModel> updateCliente(Long id, ClienteModel clienteDetails) {
        return clienteRepository.findById(id)
            .map(clienteToUpdate -> {
                ...
                // No actualizar password ni fechaRegistro
